...
(define-key *top-map* (kbd "s-j") "next-in-frame") ;window
(define-key *top-map* (kbd "s-k") "previous-in-frame") ;window
(define-key *top-map* (kbd "s-o") "other-in-frame") ;window
(define-key *top-map* (kbd "s-n") "fnext") ;frame
(define-key *top-map* (kbd "s-p") "fother");frame
