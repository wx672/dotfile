...
(custom-theme-set-faces
 ...
 '(highlight ((t (:background "LightCyan4" :inverse-video nil))))
 ...
 '(slime-repl-prompt-face ((((class color) (min-colors 89)) (:underline nil :weight bold :foreground "#b39ddb"))))
 '(slime-repl-result-face ((((class color) (min-colors 89)) (:foreground "#8bc34a"))))
 '(slime-repl-output-face ((((class color) (min-colors 89)) (:foreground "#4dd0e1" :background "#263238"))))
